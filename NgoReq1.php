...
<div id="myModal" class="modal fade">
	<div class="modal-dialog modal-lg contact-modal">
		<div class="modal-content">
            <form action="NgoReq1Form.php" method="post">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <textarea name="reason" class="form-control" id="inputMessage" placeholder="Mention Donation here with reason" required></textarea>
                            </div>
                        </div>
                    </div>                    
                </div>
