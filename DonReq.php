...
<div id="myModal" class="modal fade">
	<div class="modal-dialog modal-lg contact-modal">
		<div class="modal-content">
            <form action="DonReqForm.php" method="post">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <textarea name="description" class="form-control" id="inputMessage" placeholder="I would like to Donate...." required></textarea>
                            </div>
                        </div>
                    </div>                    
                </div>
