<%-- 
    Document   : calender
    Created on : Apr 7, 2020, 7:25:01 AM
    Author     : ANIL
--%>
...
<head>
    ...
    <meta name="viewport" content="width=device-width,initial-scale=1">
     <title>NGO Admin Dashboard</title>    <!-- Favicon icon -->
                            ...
                            <div class="drop-down dropdown-profile   dropdown-menu">
                                <div class="dropdown-content-body">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="pagelock.html"><i class="icon-lock"></i> <span>Lock Screen</span></a>
                                        </li>
                                        <li><a href="pagelogin.html"><i class="icon-key"></i> <span>Logout</span></a></li>
                                    </ul>
                                </div>
                            </div>
                        </li>
