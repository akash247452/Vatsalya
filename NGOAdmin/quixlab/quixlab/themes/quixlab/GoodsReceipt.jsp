  ...
  <div role="main" class="form-all">
    <ul class="form-section page-section">
      ...
      <li class="form-line" data-type="control_fullname" id="id_3">
        <label class="form-label form-label-left form-label-auto" id="label_3" for="first_3"> Donor Name <span class="form-required">
            *
          </span></label>
      ...
      <li class="form-line jf-required" data-type="control_text" id="id_30">
        ...
        <div id="cid_30" class="form-input-wide jf-required">
          <input type="text" id="input_30" name="q30_email30" class="form-textbox validate[required, Email]" size="30" value="" placeholder="ex: name of the NGO" data-component="email" aria-labelledby="label_30" required="" />
        </div>
      </li>
      <li class="form-line" data-type="control_number" id="id_5">
        <label class="form-label form-label-left form-label-auto" id="label_5" for="input_5"> Receipt Number <span class="form-required">
            *
          </span></label>
      ...
      <li class="form-line jf-required" data-type="control_dropdown" id="id_43">
        ...
        <div id="cid_43" class="form-input-wide jf-required">
          <select class="form-dropdown validate[required]" id="input_43" name="q43_typeA" style="width:250px" data-component="dropdown" required="" aria-labelledby="label_43">
            <option value="">  </option>
      ...
      <li class="form-line" data-type="control_textbox" id="id_46">
        <label class="form-label form-label-top form-label-auto" id="label_46" for="input_46"> Quantity of Donation <span class="form-required">
            *
          </span></label>
        <div id="cid_46" class="form-input-wide">
          <input type="text" id="input_46" name="q46_quantityOf" data-type="input-textbox" class="form-textbox" size="20" value="" data-component="textbox" aria-labelledby="label_46" />
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_textarea" id="id_44">
        <label class="form-label form-label-top form-label-auto" id="label_44" for="input_44">
          Describe Others in Detail
          <span class="form-required">
            *
          </span>
        </label>
        <div id="cid_44" class="form-input-wide jf-required">
          <textarea id="input_44" class="form-textarea validate[required]" name="q44_describeOthers" cols="40" rows="6" data-component="textarea" required="" aria-labelledby="label_44"></textarea>
        </div>
      </li>
      <li class="form-line" data-type="control_signature" id="id_9">
        <label class="form-label form-label-left form-label-auto" id="label_9" for="input_9"> Signature <span class="form-required">
            *
          </span></label>
