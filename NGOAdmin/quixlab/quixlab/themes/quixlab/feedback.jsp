<%-- 
    Document   : feedback
    Created on : Apr 9, 2020, 11:26:22 AM
    Author     : ANIL
--%>
                            ...
                            <div class="drop-down dropdown-profile animated fadeIn dropdown-menu">
                                <div class="dropdown-content-body">
                                    <ul>
                                        ...
                                        <hr class="my-2">
                                        <li>
                                            <a href="pagelock.jsp"><i class="icon-lock"></i> <span>Lock Screen</span></a>
                                        </li>
                                        <li><a href="pagelogin.jsp"><i class="icon-key"></i> <span>Logout</span></a></li>
                                    </ul>
                                </div>
                            </div>
                        </li>
