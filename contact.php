                ...
                <div class="container-fluid p-0">
                    <div class="row align-items-center justify-content-between no-gutters">
                        <div class="col-xl-2 col-lg-2">
                            <div class="logo-img">
                                <a href="index.html">
                                    <img src="img/anil projectlogo.png" width="250px" alt="">
                                </a>
                            </div>
                        </div>
                                ...
                                <nav>
                                    <ul id="navigation">
                                        ...
                                        <li><a href="#">Register <i class="ti-angle-down"></i></a>
                                            <ul class="submenu">
                                                <li><a href="NGOREGFORM.jsp">NGO Register</a></li>
                                                <li><a href="DonorRegPg.jsp">Donor Register</a></li>
                                                
                                            </ul>
                                        </li>
                                        <li><a href="#">Login<i class="ti-angle-down"></i></a>
                                            <ul class="submenu">
                                                <li><a href="login.jsp">NGO Login</a></li>
                                                
                                                <li><a href="login.jsp">Donor Login</a></li>
                                            </ul>
                                        </li>
