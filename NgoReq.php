...
<div id="myModal" class="modal fade">
	<div class="modal-dialog modal-lg contact-modal">
		<div class="modal-content">
            <form action="NgoReqForm.php" method="post">
                <div class="modal-header">				
                    <h4 class="modal-title">Dear All Donors</h4>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <input type="text" name="adminName" class="form-control" id="inputName" placeholder="Admin Name" required>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <textarea name="quantity" class="form-control" id="inputMessage" placeholder="Mention Donation here with quantity" required></textarea>
                            </div>
                        </div>
                    </div>                    
                </div>
