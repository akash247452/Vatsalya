...
<div id="myModal" class="modal fade">
	<div class="modal-dialog modal-lg contact-modal">
		<div class="modal-content">
            <form action="goodsRequirementForm.php" method="post">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <textarea class="form-control" name="describution" id="inputMessage" placeholder="Desribe Donation here with quantity" required></textarea>
                            </div>
                        </div>
                    </div>                    
                </div>
